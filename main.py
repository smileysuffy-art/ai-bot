...
async def start(update, context):
    await update.message.reply_text("🔥 AI SELF-LEARNING BOT ACTIVE")
...
def main():
    ...
    print("🚀 RUNNING SELF-LEARNING BOT...")
    app.run_polling()
